...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Knavecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
	{"knavecoin.com", "seed.knavecoin.com"},
	{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Knavecoin is probably already running."), addrBind.ToString().c_str());
        else
